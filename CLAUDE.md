...
- Browser-sync para desarrollo local (`npm run dev` → `http://localhost:3000`)

## Design Systems disponibles

Los siguientes design systems están disponibles en `.claude/.design-system/`. Para aplicar uno, leer su README y seguir el enlace de referencia.
...
- `generated-page.html` — página principal
- `.claude/.design-system/` — design systems de referencia
